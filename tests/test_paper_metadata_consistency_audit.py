...
class PaperMetadataConsistencyAuditTests(unittest.TestCase):
    ...
    def test_full_corpus_has_no_unexplained_metadata_inconsistency(self):
        ...
        self.assertEqual(summary["papers_audited"], 636)
        self.assertEqual(summary["fields_per_paper"], 18)
        self.assertEqual(len(rows), 636 * 18)
        ...
        self.assertEqual(summary["public_paper_institution_relationships"], 1465)
        self.assertEqual(summary["map_markers"], 1466)
        self.assertEqual(summary["published_only_papers"], 528)
