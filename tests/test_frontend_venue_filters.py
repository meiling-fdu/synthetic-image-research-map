...
const metadata = new Map([
  ['__unknown__', {{name: 'Unknown venue/source', type: 'conference'}}],
  ['book', {{name: 'Book Venue', type: 'book'}}],
  ['preprint', {{name: 'arXiv', type: 'preprint'}}],
  ['journal', {{name: 'Journal Venue', type: 'journal'}}],
  ['conf-alpha', {{name: 'Alpha Conference', type: 'conference'}}],
  ['conf-zulu', {{name: 'Zulu Conference', type: 'conference'}}],
  ['conf-beta', {{name: 'Beta Conference', type: 'conference'}}],
]);
...
"""
    ...
    def test_fixed_type_order_and_grouped_venue_order(self):
        ...
        self.assertEqual(result["venues"], [
            "conf-beta", "conf-alpha", "conf-zulu", "journal", "preprint", "book", "__unknown__",
        ])
        self.assertEqual(
    ...
    def test_workshop_is_track_not_public_type(self):
        ...
        self.assertTrue(all(label.startswith("Conference · ") and label.endswith(" · Workshops")
