...
def create_or_update_confirmed_location(
    ...
    *,
    ...
    queue_normalized = normalize_institution_name(queue_row.get("institution"))
...
def mark_queue_row(
    ...
    *,
    ...
    if status not in status_values:
        raise CuratedLocationError("status must be ambiguous or unresolved")
...
def location_review_report(
    ...
    statuses = Counter(clean(row.get("location_status")) for row in reviews)
